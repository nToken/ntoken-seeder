...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "nToken-seeder\n"
...
static const string mainnet_seeds[] = {"nseed1.ntoken.org", "nseed2.ntoken.org", "nseed3.ntoken.org", ""};
static const string testnet_seeds[] = {"testnet-dns.ntoken.org", "testnet2-dns.ntoken.org", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("ntoken.org", 12455), true);
  }
  do {
